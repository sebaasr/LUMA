  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#2C2416" }}>
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b"
        ...
        <div className="px-3 py-2 rounded-xl" style={{ background: "#FAF0E8" }}>
          <LumaLogo size="xs" />
        </div>
        ...
        {mode === "home" && (
          <div className="w-full max-w-md text-center">
            <div className="mb-6 flex justify-center">
              <Image src="/brand/expresionLumaAmarilla.png" alt="" width={96} height={96}
                style={{ objectFit: "contain" }} />
            </div>
            <h1 style={{ fontFamily: "'Fredoka', sans-serif", fontSize: "2.4rem", color: "#EDCC3D" }}>
              ¡Bienvenidos a LUMA!
            </h1>
          ...
          <div className="w-full max-w-md">
            ...
            {alreadyCheckedIn ? (
              ...
              <button onClick={handleCheckIn}
                ...
                style={{ background: "linear-gradient(135deg, #B8CC6E, #80C4B0)" }}>
                <Check size={20} className="inline mr-2" />Confirmar check-in
              </button>
            )}
          </div>
        )}
