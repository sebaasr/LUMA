                ...
                {([
                  {
                    ...
                    img: "/brand/expresionLumaAmarilla.png",
                  ...
                  <button key={opt.type} onClick={() => { setSessionType(opt.type); setStep(1); }}
                    ...
                    <Image src={opt.img} alt={opt.title} width={72} height={72}
                      style={{ objectFit: "contain" }} className="mb-3" />
          ...
          {step === 3 && (
            <div className="text-center py-6">
              <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg"
                style={{ background: "linear-gradient(135deg, #EDCC3D, #B8CC6E)" }}>
